from attic.radio.schedulers.schedulers_config import TIME_GRANULARITY, RB_THROUGHPUT_DL, NUM_OF_RB_DL, USE_RAN_SIMULATOR
...
class DownlinkScheduler:
    ...
    def __init__(self, bs_served, name="dl_scheduler", env=None, bs_id=None):
        ...
        self.rb_throughput = RB_THROUGHPUT_DL  # In bits
