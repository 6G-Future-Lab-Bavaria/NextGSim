import json
from attic.config.config_python import *
from edge.entities.Entity import *
from edge.entities.Gateway import Gateway
from edge.entities.BaseStation import BaseStation
from edge.entities.EdgeServer import EdgeServer
from edge.network.Link import LINK_LIST, add_link, link_does_exist
...
def create_random_grid_topology():
    ...
    with open('../topologies/random_ran_topology.json', 'w+') as json_file:
        try:
