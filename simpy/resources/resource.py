...
Processes *request* these resources to become a device and have to *release* them
...
class Preempted(object):
    ...
    def __init__(self, by, usage_since, resource):
        ...
        """The ran_simulation time at which the preempted process started to use
        the resource."""
...
class PriorityRequest(Request):
    ...
    *resource* supports preemption and *preempt* is ``True`` other usage
    ...
    def __init__(self, resource, priority=0, preempt=True):
        ...
        """Indicates whether the request should preempt a resource device or not
