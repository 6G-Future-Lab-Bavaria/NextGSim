...
class June8Plots:
    ...
    def plot_graph(self):
        ...
        ax.legend([element["boxes"][0] for element in box_plots],
                  [labels[idx] for idx, _ in enumerate(data_groups)], bbox_to_anchor=(0.5, 1.08), fontsize=fontsize-10, ncol=3, loc='center')
...
class June9InstancePlots:
    ...
    def plot_graph(self):
        ...
        ax.legend([element["boxes"][0] for element in box_plots],
                  [labels[idx] for idx, _ in enumerate(data_groups)], fontsize=fontsize - 10, loc='upper center', ncol=2,
